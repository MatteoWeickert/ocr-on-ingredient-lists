...
def run_traditional_pipeline(model: YOLO, paths: List[Path], target_id: int, out_dir: Path, product_id: str, sym_spell: SymSpell) -> Dict[str, Any]:
    """
    ...
    result = _execute_extraction_logic(model, paths, target_class, target_id, out_dir, product_id, sym_spell)
...
def _execute_extraction_logic(model: YOLO, image_paths: List[Path], target_class: str, target_class_id: int, out_dir: Path, product_id: str, sym_spell: SymSpell) -> Dict[str, Any]:
    """
