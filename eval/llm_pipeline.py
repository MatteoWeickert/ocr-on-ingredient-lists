...
def run_llm_pipeline(image_paths: List[str], class_filter: str) -> str:
    ...
    if not encoded_images:
        return {"text": "Keine gültigen Bilder für die LLM-Analyse gefunden.", "total_tokens": 0, "cost_usd": 0.0}
    ...
    try:
        ...
        return {"text": "API_ERROR", "total_tokens": 0, "cost_usd": 0.0}
        ...
        return (
            ...
            2.  **STRUCTURE MAPPING:**
                ...
                - **"rows":** An array of objects, where each object represents a row in the table.
                    ...
                    - The number of items in "values" + 1 (for the label) MUST EXACTLY MATCH the number of items in "columns". It always has to be the exact number.
            ...
            -   **THE NUMBER OF COLUMNS MUST EXACTLY MATCH THE NUMBER OF VALUES + 1 (as the label column is included).**
            -   **IF YOU CAN'T FIND A NUTRITION TABLE ON THE PRODUCT, RETURN AN EMPTY JSON OBJECT: `{}`.**
