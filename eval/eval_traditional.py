...
def run_traditional(cfg: dict, oem: int, psm: int, distance_threshold_factor: float):
    ...
    for product_id, paths in grouped_images.items():
        ...
        trad_result, mem_peak = measure_ram_peak(run_traditional_pipeline, model, paths, target_id, new_out_dir, product_id, oem, psm, distance_threshold_factor, sym_spell)
